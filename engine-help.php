<?php
	...
	$value = mysqli_fetch_array($if_game_get_id);
	$game_id = $value['gameid'];

	$games_query = $connection->query("SELECT * FROM games WHERE gameid='$game_id';");
	$value = mysqli_fetch_array($games_query);
	$beurt = $value['beurt'];
	...
	$value = mysqli_fetch_array($posities_query);
